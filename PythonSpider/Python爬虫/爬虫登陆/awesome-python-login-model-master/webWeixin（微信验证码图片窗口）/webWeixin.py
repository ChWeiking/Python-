...
def main():
    ...
    for x in MemberList:
        ...
        #包含特殊字符处理https://blog.csdn.net/qq_16272049/article/details/79492020
        non_bmp_map = dict.fromkeys(range(0x10000, sys.maxunicode + 1), 0xfffd)
        print('昵称:%s, 性别:%s, 备注:%s, 签名:%s' % (x['NickName'].translate(non_bmp_map), sex, x['RemarkName'].translate(non_bmp_map), x['Signature'].translate(non_bmp_map)))
